...
\job{Staff Software Engineer @ Auth0 (by Okta)}
{Remote, Feb'21--Cur.}
{As Tech Lead and founding member of the IAM Core Crypto team, I have been an important part of the team creation, hiring, and discovery phase of the crypto needs for Auth0.
We chose to go towards internal Crypto-as-a-service services that will improve our abilities with respect to key management and data compliance and also provide new capabilities such as Bring Your Own Key (BYOK) or Control Your Own Key (CYOK).
As a tech lead, my main duties are tasks management, people mentorship, and design and development of performant GRPC backend services written in Go and consumed by Node.js services using our Typescript SDK.\\
Moreover, I have had cross-team impact by being involved in closing deals with two big companies and also saved more than 100k\$ yearly costs in infrastructure without affecting the QoS.\\}
