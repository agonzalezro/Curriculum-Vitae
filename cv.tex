...
Technology-wise the seed of this product was a NextJS/React application consuming an API made with Phoenix using JSON Web Token (JWT) and Go for the workers, everything deployed on AWS.\\
