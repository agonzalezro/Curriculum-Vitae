...
\address{Ebbingedwinger, 16}{9712 MA -- Groningen (Holland)}    % optional, remove the line if not wanted
...
\cventry{May 2011--Act.}{Programador}{Paylogic}{Holanda}{}{Desarrollador backend, he creado una API RESTful que es el punto de entrada entre las aplicaciones móviles y todos los servicios de Paylogic y redes sociales. También trabajo frecuentemente en el backoffice de Paylogic.}
